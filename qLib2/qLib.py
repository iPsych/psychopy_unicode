...
def textInput(window, clock=None,
    ...
    next = visual.ImageStim(window,image=pngPath+'next.png', units = 'norm', pos=(0,-0.9))
    textfield = visual.TextStim(window,text=message+'_',font='AppleGothic',height=.05,alignVert='top', alignHoriz='left',color='black',pos=(-boxWidth+0.05,boxTop-0.05), wrapWidth=boxWidth*2-0.1)
    ...
    window.flip()
    message=str(message.encode('euc-kr'))
